 ...
 */
final class Version20200609092904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, class_id_id INT NOT NULL, exam_id_id INT NOT NULL, user_name VARCHAR(255) NOT NULL, roles JSON NOT NULL, pass_word VARCHAR(255) NOT NULL, INDEX IDX_8D93D6499993BF61 (class_id_id), INDEX IDX_8D93D6492DA198E7 (exam_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
